...
<xsl:template match="/atom:feed">
	...
	<meta name="description" content="Hi, my name is Mihai Nicolae. I am a software engineer working in the Bay Area. Welcome to my personal website.">
	...
	<meta property="og:description" content="Hi, my name is Mihai Nicolae. I am a software engineer working in the Bay Area. Welcome to my personal website.">
	<meta property="og:url" content="http://localhost:4000/assets/xslt/atom.xslt">
	<meta property="og:locale" content="en_EN">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Mihai Nicolae">
	...
	<meta name="twitter:description" content="Hi, my name is Mihai Nicolae. I am a software engineer working in the Bay Area. Welcome to my personal website.">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Mihai Nicolae</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Mihai Nicolae – Mihai musing on the Internet">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Mihai Nicolae – Mihai musing on the Internet">
			</a>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              Hi, my name is Mihai Nicolae. I am a software engineer working in the Bay Area. Welcome to my personal website.
        ...
        <nav class="row">
          ...
          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
              ...
              <li><a href="http://github.com/mnicolae" target="_blank" class="icon-github" title="Personal Github account"></a></li>
            
              <li><a href="https://twitter.com/mihain91" target="_blank" class="icon-twitter" title="Twitter account"></a></li>
